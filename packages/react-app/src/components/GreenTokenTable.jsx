  ...
  const tokenData = [
    {
      ...
      co2: <TokenBalance contracts={readContracts} name={'PMCO2'} address={address} />,
    },
    {
      key: '2',
      ...
      co2: <TokenBalance contracts={readContracts} name={'PBCT'} address={address} />,
    },
    {
      key: '3',
      name: 'Toucan CO2 Tokens (NCT)',
      hold: <TokenBalance contracts={readContracts} name={'NCT'} address={address} />,
      desc: 'Nature Carbon Ton: Toucan premium credits bridged to blockchain on Polygon',
      co2: <TokenBalance contracts={localContracts} name={'NCT'} address={address} />,
    },
    {
      key: '4',
