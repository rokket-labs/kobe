...
/**
  type ContextProps = {
    ...
    handleIsPledged: (pledged: boolean) => void
    handleCo2: (value: number) => void
    handleHasCalculator: (calculator: boolean) => void
  }
*/
...
export const IsPledgedProvider = ({ children }) => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined')
      setHasCalculator(!!getItem('hasCalculator'))
  }, [getItem])
  ...
  return (
    <IsPledgedContext.Provider value={value}>
      {children}
    </IsPledgedContext.Provider>
  )
}
