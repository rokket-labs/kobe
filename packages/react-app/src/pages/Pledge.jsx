    ...
    <Row justify="center" style={{ marginBottom: '5rem' }}>
      ...
      <Col xl={13} xs={22}>
        <Paragraph style={{ fontSize: 24, lineHeight: '2.5rem' }}>
          ...
          We ask you to make a commitment, just like our nation&apos;s leaders have, to offset/reduce your annual CO2 footprint.
          Now the important....your pledge
        </Paragraph>
      </Col>
      <Col xl={13} xs={22}>
        <Paragraph style={{ fontSize: 24, lineHeight: '3rem' }}>
          <ul>
            <li>I hereby pledge to do my best to save the planet. <StyledIcon src={'icon/planet.svg'} preview={false} /></li>
            <li>I pledge to do my best to reduce emissions, by consuming less or by being more conscious about my
            decisions.
            <StyledIcon src={'icon/burger.svg'} preview={false} /> <StyledIcon src={'icon/recycle.svg'} preview={false} /></li>
            <li>I pledge to help others in their paths to help the planet.{' '}
            <StyledIcon src={'icon/humans.svg'} preview={false} /></li>
      ...
      <Col xl={13} xs={22}>
        <Paragraph style={{ fontSize: 24, lineHeight: '3rem' }}>
          <ul>
            <li>I pledge to grow a Forest, to be a Forest within my community, to take small, steady, and concrete steps to
