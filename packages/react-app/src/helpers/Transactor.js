    ...
    return async (tx, callback) => {
      ...
      try {
        ...
        if (tx instanceof Promise) {
          ...
          if (!tx.gasPrice) tx.gasPrice = gasPrice || ethers.utils.parseUnits('4.1', 'gwei')

          if (!tx.gasLimit) tx.gasLimit = ethers.utils.hexlify(120000)
        ...
        if (!e.error && e.message) message = e.message
        ...
        try {
          ...
          if (obj && obj.body) {
            ...
            if (errorObj && errorObj.error && errorObj.error.message) message = errorObj.error.message
          }
        } catch (e) {
          // ignore
        }
